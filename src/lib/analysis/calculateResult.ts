...
export function calculateResult(input: RawResultInput): ProductResult {
  ...
  return {
    ...
    marketMap: {
      ...
      legend: [
        { label: "Окно возможности", riskLevel: "low", className: "bg-primary-green" },
        { label: "Плотная зона", riskLevel: "medium", className: "bg-warning" },
        { label: "Риск позиции", riskLevel: "high", className: "bg-risk" },
        { label: "Ваш товар", riskLevel: "user", className: "bg-charcoal" },
      ],
    },
    margin,
    packaging,
